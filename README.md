...
> **You are on the `pytorch-2.9-vllm-0.14.0` branch** — PyTorch 2.9.1 + CUDA 12.9 (73 variants, vLLM 0.14.0 pin-aligned)
...
| **`pytorch-2.9-vllm-0.14.0`** ⬅️ | **2.9.1** | **12.9** | **73** | **This branch** — vLLM 0.14.0 pin-aligned (nixpkgs `46336d4`) |
...
**This branch builds PyTorch 2.9.1 with CUDA 12.9** — 73 variants covering all GPU architectures plus SM70 (Volta), SM75 (Turing), SM103 (B300), AVX-only variants for legacy CPUs, and 1 Darwin/macOS variant.
...
| **`pytorch-2.9-vllm-0.14.0`** ⬅️ | 2.9.1 | 12.9 | SM61–SM120, SM70, SM75, SM103, CPU, Darwin | 73 (this branch — vLLM 0.14.0 aligned) |
...
│   └── pkgs/                      # Nix expression builds (73 variants on this branch)
...
│       ├── pytorch-python312-cuda12_9-sm103-*.nix # 7 SM103 variants (B300)
