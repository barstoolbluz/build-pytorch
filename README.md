...
| **`pytorch-2.9-vllm-0.15.1`** ⬅️ | **2.9.1** | **12.9** | **66** | **This branch** — vLLM pin-aligned (nixpkgs `0182a36`) |
...
| **`pytorch-2.9-vllm-0.15.1`** ⬅️ | 2.9.1 | 12.9 | SM61–SM120, SM75, SM103, CPU, Darwin | 66 (this branch — vLLM aligned) |
