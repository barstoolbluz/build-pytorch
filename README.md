...
| **`cuda-13_0`** ⬅️ | **2.10** | **13.0** | **68** | **This branch** — Full matrix SM75–SM121 + ARM + AVX-only + Darwin MPS |
...
| `cuda-12_9` | **2.9.1** | **12.9.1** | SM61–SM120 + SM75/SM103 + AVX-only, Darwin | **66** (recommended) |
