...
> **You are on the `pytorch-2.9-python313` branch** — PyTorch 2.9.1 + CUDA 13.0 / 12.9.1 / 12.8 (177 variants)
...
| **`pytorch-2.9-python313`** ⬅️ | **2.9.1** | **13.0 / 12.9.1 / 12.8** | **3.13** | **177** | **This branch** — Full coverage + SM75/SM103/SM110/SM121 + AVX-only + Darwin MPS |
...
| `pytorch-2.10-python313` | 2.10 | 13.0 / 13.1 / 12.9 / 12.8 | 3.13 | 237 | Full matrix SM75–SM121 + ARM + AVX-only + Darwin MPS |
...
| **`pytorch-2.9-python313`** ⬅️ | **2.9.1** | **13.0** | **9.x** | **3.13** | **570+** | [**`0182a36`**](https://github.com/NixOS/nixpkgs/tree/0182a361324364ae3f436a63005877674cf45efb) |
...
| `pytorch-2.10-python313` | 2.10 | 12.8 | 9.x | 3.13 | 550+ | [`0182a36`](https://github.com/NixOS/nixpkgs/tree/0182a361324364ae3f436a63005877674cf45efb) |

## Build Matrix (this branch: pytorch-2.9-python313)

**This branch builds PyTorch 2.9.1 with CUDA 13.0, 12.9.1, and 12.8** — 177 variants covering all GPU architectures from SM61 (Pascal) through SM121 (DGX Spark), AVX-only variants for legacy CPUs, and 1 Darwin/macOS variant. CUDA 13.0 provides 60 GPU variants (adds SM110/SM121, drops SM61); CUDA 12.9.1 provides 58 GPU + 8 CPU/MPS variants (66 total); CUDA 12.8 adds 51 GPU variants (same as 12.9 minus SM103).

### Complete Variant Matrix — CUDA 12.9.1 (58 GPU + 8 non-GPU = 66)

| GPU Architecture | CPU ISA | Package Name | Primary Use Case |
|-----------------|---------|--------------|------------------|
| **CPU-only** | AVX | `pytorch-python313-cpu-avx` | Sandy Bridge+ maximum compatibility |
| | AVX2 | `pytorch-python313-cpu-avx2` | Development, broad x86-64 compatibility |
...
| **SM75 (Turing)** | AVX | `pytorch-python313-cuda12_9-sm75-avx` | T4/RTX 2080 Ti + legacy AVX CPUs |
| | AVX2 | `pytorch-python313-cuda12_9-sm75-avx2` | T4/RTX 2080 Ti + broad CPU compatibility |
| | AVX-512 | `pytorch-python313-cuda12_9-sm75-avx512` | T4/RTX 2080 Ti + general workloads |
| | AVX-512 BF16 | `pytorch-python313-cuda12_9-sm75-avx512bf16` | T4/RTX 2080 Ti + BF16 training |
| | AVX-512 VNNI | `pytorch-python313-cuda12_9-sm75-avx512vnni` | T4/RTX 2080 Ti + INT8 inference |
| | ARMv8.2 | `pytorch-python313-cuda12_9-sm75-armv8_2` | T4/RTX 2080 Ti + ARM Graviton2 |
| | ARMv9 | `pytorch-python313-cuda12_9-sm75-armv9` | T4/RTX 2080 Ti + ARM Grace |
| **SM80 (Ampere DC)** | AVX | `pytorch-python313-cuda12_9-sm80-avx` | A100/A30 + legacy AVX CPUs |
| | AVX2 | `pytorch-python313-cuda12_9-sm80-avx2` | A100/A30 + broad CPU compatibility |
| | AVX-512 | `pytorch-python313-cuda12_9-sm80-avx512` | A100/A30 + general workloads |
| | AVX-512 BF16 | `pytorch-python313-cuda12_9-sm80-avx512bf16` | A100/A30 + BF16 training |
| | AVX-512 VNNI | `pytorch-python313-cuda12_9-sm80-avx512vnni` | A100/A30 + INT8 inference |
| | ARMv8.2 | `pytorch-python313-cuda12_9-sm80-armv8_2` | A100/A30 + ARM Graviton2 |
| | ARMv9 | `pytorch-python313-cuda12_9-sm80-armv9` | A100/A30 + ARM Grace |
| **SM86 (Ampere)** | AVX | `pytorch-python313-cuda12_9-sm86-avx` | RTX 3090/A40 + legacy AVX CPUs |
| | AVX2 | `pytorch-python313-cuda12_9-sm86-avx2` | RTX 3090/A40 + broad CPU compatibility |
| | AVX-512 | `pytorch-python313-cuda12_9-sm86-avx512` | RTX 3090/A40 + general workloads |
| | AVX-512 BF16 | `pytorch-python313-cuda12_9-sm86-avx512bf16` | RTX 3090/A40 + BF16 training |
| | AVX-512 VNNI | `pytorch-python313-cuda12_9-sm86-avx512vnni` | RTX 3090/A40 + INT8 inference |
| | ARMv8.2 | `pytorch-python313-cuda12_9-sm86-armv8_2` | RTX 3090/A40 + ARM Graviton2 |
| | ARMv9 | `pytorch-python313-cuda12_9-sm86-armv9` | RTX 3090/A40 + ARM Grace |
| **SM89 (Ada)** | AVX | `pytorch-python313-cuda12_9-sm89-avx` | RTX 4090/L40 + legacy AVX CPUs |
| | AVX2 | `pytorch-python313-cuda12_9-sm89-avx2` | RTX 4090/L40 + broad CPU compatibility |
| | AVX-512 | `pytorch-python313-cuda12_9-sm89-avx512` | RTX 4090/L40 + general workloads |
| | AVX-512 BF16 | `pytorch-python313-cuda12_9-sm89-avx512bf16` | RTX 4090/L40 + BF16 training |
| | AVX-512 VNNI | `pytorch-python313-cuda12_9-sm89-avx512vnni` | RTX 4090/L40 + INT8 inference |
| | ARMv8.2 | `pytorch-python313-cuda12_9-sm89-armv8_2` | RTX 4090/L40 + ARM Graviton2 |
| | ARMv9 | `pytorch-python313-cuda12_9-sm89-armv9` | RTX 4090/L40 + ARM Grace |
| **SM90 (Hopper)** | AVX | `pytorch-python313-cuda12_9-sm90-avx` | H100/L40S + legacy AVX CPUs |
| | AVX2 | `pytorch-python313-cuda12_9-sm90-avx2` | H100/L40S + broad CPU compatibility |
| | AVX-512 | `pytorch-python313-cuda12_9-sm90-avx512` | H100/L40S + general workloads |
| | AVX-512 BF16 | `pytorch-python313-cuda12_9-sm90-avx512bf16` | H100/L40S + BF16 training |
| | AVX-512 VNNI | `pytorch-python313-cuda12_9-sm90-avx512vnni` | H100/L40S + INT8 inference |
| | ARMv8.2 | `pytorch-python313-cuda12_9-sm90-armv8_2` | H100/L40S + ARM Graviton2 |
| | ARMv9 | `pytorch-python313-cuda12_9-sm90-armv9` | H100/L40S + ARM Grace |
| **SM100 (Blackwell DC)** | AVX | `pytorch-python313-cuda12_9-sm100-avx` | B100/B200 + legacy AVX CPUs |
| | AVX2 | `pytorch-python313-cuda12_9-sm100-avx2` | B100/B200 + broad CPU compatibility |
| | AVX-512 | `pytorch-python313-cuda12_9-sm100-avx512` | B100/B200 + general workloads |
| | AVX-512 BF16 | `pytorch-python313-cuda12_9-sm100-avx512bf16` | B100/B200 + BF16 training |
| | AVX-512 VNNI | `pytorch-python313-cuda12_9-sm100-avx512vnni` | B100/B200 + INT8 inference |
| | ARMv8.2 | `pytorch-python313-cuda12_9-sm100-armv8_2` | B100/B200 + ARM Graviton2 |
| | ARMv9 | `pytorch-python313-cuda12_9-sm100-armv9` | B100/B200 + ARM Grace |
| **SM103 (Blackwell DC)** | AVX | `pytorch-python313-cuda12_9-sm103-avx` | B300 + legacy AVX CPUs |
| | AVX2 | `pytorch-python313-cuda12_9-sm103-avx2` | B300 + broad CPU compatibility |
| | AVX-512 | `pytorch-python313-cuda12_9-sm103-avx512` | B300 + general workloads |
| | AVX-512 BF16 | `pytorch-python313-cuda12_9-sm103-avx512bf16` | B300 + BF16 training |
| | AVX-512 VNNI | `pytorch-python313-cuda12_9-sm103-avx512vnni` | B300 + INT8 inference |
| | ARMv8.2 | `pytorch-python313-cuda12_9-sm103-armv8_2` | B300 + ARM Graviton2 |
| | ARMv9 | `pytorch-python313-cuda12_9-sm103-armv9` | B300 + ARM Grace |
| **SM61 (Pascal)** | AVX | `pytorch-python313-cuda12_9-sm61-avx` | GTX 1070/1080 Ti + legacy AVX CPUs |
| | AVX2 | `pytorch-python313-cuda12_9-sm61-avx2` | GTX 1070/1080 Ti + modern CPUs |
| **SM120 (Blackwell)** | AVX | `pytorch-python313-cuda12_9-sm120-avx` | RTX 5090 + legacy AVX CPUs |
| | AVX2 | `pytorch-python313-cuda12_9-sm120-avx2` | RTX 5090 + broad CPU compatibility |
| | AVX-512 | `pytorch-python313-cuda12_9-sm120-avx512` | RTX 5090 + general workloads |
| | AVX-512 BF16 | `pytorch-python313-cuda12_9-sm120-avx512bf16` | RTX 5090 + BF16 training |
...
### CUDA 13.0 Variants — 60 GPU Variants

*Adds SM110 (DRIVE Thor) and SM121 (DGX Spark) which require CUDA 13.0+. Drops SM61 (Pascal, not supported by CUDA 13.0). Package pattern: `pytorch-python313-cuda13_0-{gpu}-{cpu}`*

CUDA 13.0 variants use the same nixpkgs pin [`0182a36`](https://github.com/NixOS/nixpkgs/tree/0182a361324364ae3f436a63005877674cf45efb) with `cudaPackages_13_0`. Requires driver 570+.

**GPU architectures:** SM75 (7), SM80 (7), SM86 (7), SM89 (7), SM90 (7), SM100 (7), SM103 (7), SM110 (2 ARM only), SM120 (7), SM121 (2 ARM only)

```bash
# Example: Build CUDA 13.0 variant
flox build pytorch-python313-cuda13_0-sm90-avx512

# CUDA 13.0-only architectures
flox build pytorch-python313-cuda13_0-sm110-armv9   # DRIVE Thor
flox build pytorch-python313-cuda13_0-sm121-armv9   # DGX Spark
```

### CUDA 12.8 Variants — 51 GPU Variants

*Same GPU/CPU matrix as CUDA 12.9 minus SM103 (CUDA 12.8 does not support sm_103). Package pattern: `pytorch-python313-cuda12_8-{gpu}-{cpu}`*

CUDA 12.8 variants use the same nixpkgs pin [`0182a36`](https://github.com/NixOS/nixpkgs/tree/0182a361324364ae3f436a63005877674cf45efb) with `cudaPackages_12_8`. Requires driver 550+.

**GPU architectures:** SM61 (2 ISA: AVX, AVX2), SM75 (7), SM80 (7), SM86 (7), SM89 (7), SM90 (7), SM100 (7), SM120 (7)

```bash
# Example: Build CUDA 12.8 variant
...
| **`pytorch-2.9-python313`** ⬅️ | 2.9.1 | 13.0 / 12.9.1 / 12.8 | SM61–SM121, SM75, SM103, SM110, CPU, Darwin | 177 (Python 3.13, this branch) |
...
| `pytorch-2.10-python313` | 2.10 | 13.0 / 13.1 / 12.9 / 12.8 | SM75–SM121 + ARM + AVX-only, Darwin | 237 (Python 3.13) |
...
**SM121 (DGX Spark) - Compute Capability 12.1** *(this branch via CUDA 13.0; also pytorch-2.10-python313)*
- Specialized Datacenter: DGX Spark
- Driver: NVIDIA 570+
- CUDA: Requires 13.0+ (nvcc 12.9 does not recognize sm_121)
...
**SM110 (Blackwell Thor/NVIDIA DRIVE) - Compute Capability 11.0** *(this branch via CUDA 13.0; also pytorch-2.10-python313)*
- Automotive/Edge: NVIDIA DRIVE platforms (Thor, Orin+)
- Driver: NVIDIA 570+
- CUDA: Requires 13.0+ (nvcc 12.9 does not recognize sm_110)
...
# Build variant
flox build pytorch-python313-cuda12_9-sm86-avx512
```
...
# For INT8 inference
flox build pytorch-python313-cuda12_9-sm90-avx512vnni
```
...
# The result will be in ./result-pytorch-python313-cuda12_9-sm90-avx512/
ls -lh result-pytorch-python313-cuda12_9-sm90-avx512/lib/python3.13/site-packages/torch/
```
...
│   └── pkgs/                      # Nix expression builds (177 variants on this branch)
│       ├── pytorch-python313-cpu-*.nix            # 7 CPU-only variants (Linux)
│       ├── pytorch-python313-darwin-mps.nix       # MPS variant (Apple Silicon)
│       ├── pytorch-python313-cuda13_0-sm75-*.nix  # 7 SM75 variants (CUDA 13.0)
│       ├── pytorch-python313-cuda13_0-sm80-*.nix  # 7 SM80 variants (CUDA 13.0)
│       ├── pytorch-python313-cuda13_0-sm86-*.nix  # 7 SM86 variants (CUDA 13.0)
│       ├── pytorch-python313-cuda13_0-sm89-*.nix  # 7 SM89 variants (CUDA 13.0)
│       ├── pytorch-python313-cuda13_0-sm90-*.nix  # 7 SM90 variants (CUDA 13.0)
│       ├── pytorch-python313-cuda13_0-sm100-*.nix # 7 SM100 variants (CUDA 13.0)
│       ├── pytorch-python313-cuda13_0-sm103-*.nix # 7 SM103 variants (CUDA 13.0)
│       ├── pytorch-python313-cuda13_0-sm110-*.nix # 2 SM110 variants (CUDA 13.0, ARM only)
│       ├── pytorch-python313-cuda13_0-sm120-*.nix # 7 SM120 variants (CUDA 13.0)
│       ├── pytorch-python313-cuda13_0-sm121-*.nix # 2 SM121 variants (CUDA 13.0, ARM only)
│       ├── pytorch-python313-cuda12_9-sm61-*.nix  # 2 SM61 variants (Pascal)
│       ├── pytorch-python313-cuda12_9-sm75-*.nix  # 7 SM75 variants (Turing)
│       ├── pytorch-python313-cuda12_9-sm80-*.nix  # 7 SM80 variants
│       ├── pytorch-python313-cuda12_9-sm86-*.nix  # 7 SM86 variants
...
│       ├── pytorch-python313-cuda12_8-sm61-*.nix  # 2 SM61 variants (CUDA 12.8)
│       ├── pytorch-python313-cuda12_8-sm75-*.nix  # 7 SM75 variants (CUDA 12.8)
...
flox publish -o <your-org> pytorch-python313-cuda12_9-sm90-avx512
flox publish -o <your-org> pytorch-python313-cuda12_9-sm86-avx2
flox publish -o <your-org> pytorch-python313-cuda12_9-cpu-avx2

# Users install with:
flox install <your-org>/pytorch-python313-cuda12_9-sm90-avx512
```
...
```nix
# .flox/pkgs/pytorch-python313-cuda12_9-sm89-avx512.nix
