...
> **You are on the `pytorch-2.9-py311` branch** — PyTorch 2.9.1 + CUDA 12.9 (73 variants, Python 3.11)
...
| **`pytorch-2.9-py311`** ⬅️ | **2.9.1** | **12.9** | **73** | **This branch** — Python 3.11, pin-compatible with vLLM 0.14.0 (nixpkgs `46336d4`) |
| `pytorch-2.9-vllm-0.14.0` | 2.9.1 | 12.9 | 73 | Python 3.12, vLLM 0.14.0 pin-aligned (nixpkgs `46336d4`) |
...
| **`pytorch-2.9-py311`** ⬅️ | **2.9.1** | **12.9** | **9.13.0** | **3.11** | **550+** | [**`46336d4`**](https://github.com/NixOS/nixpkgs/tree/46336d4d6980ae6f136b45c8507b17787eb186a0) |
...
## Build Matrix (this branch: pytorch-2.9-py311)
...
| **`pytorch-2.9-py311`** ⬅️ | 2.9.1 | 12.9 | SM61–SM120, SM70, SM75, SM103, CPU, Darwin | 73 (this branch — Python 3.11) |
| `pytorch-2.9-vllm-0.14.0` | 2.9.1 | 12.9 | SM61–SM120, SM70, SM75, SM103, CPU, Darwin | 73 (Python 3.12, vLLM 0.14.0 aligned) |
...
│       ├── pytorch-python311-cuda12_9-sm103-*.nix # 7 SM103 variants (B300)
