...
# Package name: pytorch210-python313-cuda13_0-sm86-avx512vnni
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm86-avx512vnni";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM86 (RTX 30 Ampere) | CPU: AVX-512 VNNI | PyTorch 2.10.0 | CUDA 13.0"
    '';
