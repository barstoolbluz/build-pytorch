# PyTorch 2.10.0 optimized for NVIDIA T4/RTX 2080 Ti (SM75) + ARMv9
# Package name: pytorch210-python313-cuda13_0-sm75-armv9
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm75-armv9";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM75 (DRIVE Thor) | CPU: ARMv9 | PyTorch 2.10.0 | CUDA 13.0"
    '';
