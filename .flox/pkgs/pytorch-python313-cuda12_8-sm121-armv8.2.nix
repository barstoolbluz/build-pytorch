...
# Package name: pytorch-python313-cuda12_8-sm121-armv8.2
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_8-sm121-armv8.2";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        ...
        Choose this if: You have DGX Spark specialized datacenter GPU on older ARM
        platform without SVE2 support (Graviton2, Neoverse N1). For newer ARM platforms
        with SVE2, use armv9 variant instead.
      '';
