...
# Package name: pytorch-python312-cuda12_8-sm75-armv9
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python312-cuda12_8-sm75-armv9";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch for NVIDIA T4/RTX 2080 Ti (SM75, Turing) + ARMv9 (Graviton3+)";
      longDescription = ''
