# PyTorch 2.10.0 optimized for NVIDIA Ampere (SM86: RTX 3090, A5000, A40) + AVX-512 + BF16
# Package name: pytorch-python313-cuda12_9-sm86-avx512bf16
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_9-sm86-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA RTX 3090/A40 (SM86) + AVX-512 BF16";
      longDescription = ''
