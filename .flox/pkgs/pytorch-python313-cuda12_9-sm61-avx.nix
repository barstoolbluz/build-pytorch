# PyTorch 2.10.0 optimized for NVIDIA Pascal (SM61: GTX 1070, 1080, 1080 Ti) + AVX
# Package name: pytorch-python313-cuda12_9-sm61-avx
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_9-sm61-avx";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA GTX 1070/1080 Ti (SM61, Pascal) with AVX";
      longDescription = ''
