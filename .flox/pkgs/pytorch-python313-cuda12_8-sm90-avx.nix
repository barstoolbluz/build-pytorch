# PyTorch 2.10.0 optimized for NVIDIA Hopper (SM90: H100, H200, L40S) + AVX
# Package name: pytorch-python313-cuda12_8-sm90-avx
...
let
  ...
  # GPU target: SM90 (Hopper architecture - H100, H200, L40S)
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_8-sm90-avx";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (Hopper: H100, H200, L40S)"
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA H100/H200 (SM90, Hopper) with AVX";
      longDescription = ''
        ...
        Choose this if: You have a Hopper GPU and want CUDA acceleration
