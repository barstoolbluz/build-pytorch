# PyTorch optimized for NVIDIA Hopper (SM90: H100, L40S) + AVX
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch for NVIDIA H100/L40S (SM90, Hopper) with AVX";
      longDescription = ''
        ...
        Choose this if: You have an H100/L40S datacenter GPU paired with an older
