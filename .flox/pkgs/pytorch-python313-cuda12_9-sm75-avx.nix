# PyTorch 2.10.0 optimized for NVIDIA Turing (SM75: T4, RTX 2080 Ti, Quadro RTX 8000) + AVX
# Package name: pytorch-python313-cuda12_9-sm75-avx
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_9-sm75-avx";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA T4/RTX 2080 Ti (SM75, Turing) with AVX";
      longDescription = ''
