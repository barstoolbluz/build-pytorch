# PyTorch 2.10.0 optimized for NVIDIA Ada Lovelace (SM89: RTX 4090, L40) + AVX-512 + VNNI
# Package name: pytorch-python313-cuda12_9-sm89-avx512vnni
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_9-sm89-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA RTX 4090/L40 (SM89) + AVX-512 VNNI";
      longDescription = ''
