# PyTorch 2.10.0 optimized for NVIDIA Blackwell (SM120: RTX 5090) + AVX
# Package name: pytorch-python313-cuda12_9-sm120-avx
...
let
  ...
  # GPU target: SM120 (Blackwell consumer architecture - RTX 5090)
  gpuArchNum = "120";  # For CMAKE_CUDA_ARCHITECTURES (just the integer)
  gpuArchSM = "12.0";  # For TORCH_CUDA_ARCH_LIST (dot notation)
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_9-sm120-avx";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA RTX 5090 (SM120, Blackwell) with AVX";
      longDescription = ''
        ...
        - GPU: RTX 5090 or other SM120 GPUs
        - CPU: Intel Sandy Bridge+ (2011+), AMD Bulldozer+ (2011+)
        - Driver: NVIDIA 570+ required

        Choose this if: You have a Blackwell consumer GPU and want CUDA
