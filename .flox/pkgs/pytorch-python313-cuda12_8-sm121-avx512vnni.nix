# PyTorch optimized for NVIDIA DGX Spark (SM121) + AVX-512 VNNI
# Package name: pytorch-python313-cuda12_8-sm121-avx512vnni
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_8-sm121-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch for NVIDIA DGX Spark (SM121) + AVX-512 VNNI";
      longDescription = ''
        ...
        Choose this if: You have DGX Spark specialized datacenter GPU and need INT8
        quantized model inference acceleration on CPU. For general workloads use avx512,
        for BF16 training use avx512bf16.
      '';
