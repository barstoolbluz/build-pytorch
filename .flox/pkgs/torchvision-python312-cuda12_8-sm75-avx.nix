...
# Package name: torchvision-python312-cuda12_8-sm75-avx
...
let
  ...
  customPytorch = import ./pytorch-python312-cuda12_8-sm75-avx.nix {};
...
in
  (nixpkgs_pinned.python312Packages.torchvision.override {
    ...
    pname = "torchvision-python312-cuda12_8-sm75-avx";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        Custom torchvision build matching the pytorch-python312-cuda12_8-sm75-avx variant:
