# PyTorch 2.10.0 optimized for NVIDIA Ampere (SM86: RTX 3090, A5000, A40) + ARMv9
# Package name: pytorch-python313-cuda12_9-sm86-armv9
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_9-sm86-armv9";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA RTX 3090/A40 (SM86) + ARMv9 (SVE2)";
      longDescription = ''
