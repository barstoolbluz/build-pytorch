...
# Package name: pytorch-python313-cuda12_8-sm103-avx512
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_8-sm103-avx512";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        ...
        Choose this if: You have B300 datacenter GPU and modern AVX-512 capable CPU
        for general FP32 training/inference. For specialized workloads use avx512bf16
        (BF16 training) or avx512vnni (INT8 inference).
      '';
