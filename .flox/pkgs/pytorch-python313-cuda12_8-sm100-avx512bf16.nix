# PyTorch optimized for NVIDIA Blackwell Datacenter (SM100: B100, B200) + AVX-512 + BF16
# Package name: pytorch-python313-cuda12_8-sm100-avx512bf16
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_8-sm100-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch for NVIDIA B100/B200 (SM100, Blackwell DC) + AVX-512 BF16 (mixed-precision training)";
      longDescription = ''
        ...
        Choose this if: You have B100 or B200 datacenter GPU + CPU with AVX-512 BF16 support,
