# PyTorch 2.10.0 optimized for NVIDIA Blackwell Datacenter (SM100: B100, B200) + AVX-512 + BF16
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA B100/B200 (SM100, Blackwell DC) + AVX-512 BF16";
      longDescription = ''
