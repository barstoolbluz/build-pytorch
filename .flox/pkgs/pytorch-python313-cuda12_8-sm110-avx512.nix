# PyTorch optimized for NVIDIA Blackwell Thor/DRIVE (SM110) + AVX-512
# Package name: pytorch-python313-cuda12_8-sm110-avx512
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_8-sm110-avx512";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch for NVIDIA DRIVE (SM110, Blackwell Thor) + AVX-512";
      longDescription = ''
        ...
        and modern AVX-512 capable CPU for general FP32 training/inference. For specialized
        workloads use avx512bf16 (BF16) or avx512vnni (INT8).
      '';
