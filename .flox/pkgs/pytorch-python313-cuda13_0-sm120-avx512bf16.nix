...
# Package name: pytorch-python313-cuda13_0-sm120-avx512bf16
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda13_0-sm120-avx512bf16";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "CUDA: 13.0 (cudaSupport=true, gpuTargets=[${gpuArchNum}])"
