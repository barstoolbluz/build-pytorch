# PyTorch 2.10.0 optimized for NVIDIA Hopper (SM90) + AVX
# Package name: pytorch210-python313-cuda13_1-sm90-avx
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_1-sm90-avx";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM90 (Hopper) | CPU: AVX (max compat) | PyTorch 2.10.0 | CUDA 13.1"
    '';
...
EOF
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA Hopper (SM90) + AVX";
