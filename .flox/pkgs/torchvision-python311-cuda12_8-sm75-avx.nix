...
# Package name: torchvision-python311-cuda12_8-sm75-avx
...
let
  ...
  customPytorch = import ./pytorch-python311-cuda12_8-sm75-avx.nix {};
...
in
  (nixpkgs_pinned.python311Packages.torchvision.override {
    torch = customPytorch;
  }).overrideAttrs (oldAttrs: {
    pname = "torchvision-python311-cuda12_8-sm75-avx";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        Custom torchvision build matching the pytorch-python311-cuda12_8-sm75-avx variant:
