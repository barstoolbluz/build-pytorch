...
# Package name: pytorch210-python313-cuda13_1-sm100-armv8_2
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_1-sm100-armv8_2";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM100 (B100 (Blackwell)) | CPU: ARMv8.2 | PyTorch 2.10.0 | CUDA 13.1"
    '';
