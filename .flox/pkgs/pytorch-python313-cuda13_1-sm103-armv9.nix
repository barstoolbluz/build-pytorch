...
# Package name: pytorch210-python313-cuda13_1-sm103-armv9
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_1-sm103-armv9";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM103 (B200 (Blackwell)) | CPU: ARMv9 | PyTorch 2.10.0 | CUDA 13.1"
    '';
