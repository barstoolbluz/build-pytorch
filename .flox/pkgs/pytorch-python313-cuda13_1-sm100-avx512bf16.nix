...
# Package name: pytorch210-python313-cuda13_1-sm100-avx512bf16
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_1-sm100-avx512bf16";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM100 (B100/B200) | CPU: AVX-512 BF16 | PyTorch 2.10.0 | CUDA 13.1"
    '';
