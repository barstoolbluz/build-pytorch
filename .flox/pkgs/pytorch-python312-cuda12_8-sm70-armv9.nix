# PyTorch optimized for NVIDIA Volta (SM70: V100, Titan V) + ARMv9
# Package name: pytorch-python312-cuda12_8-sm70-armv9
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python312-cuda12_8-sm70-armv9";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch for NVIDIA V100/Titan V (SM70) + ARMv9 (SVE2)";
      longDescription = ''
        ...
        Choose this if: You have V100/Titan V GPU on modern ARM server with
