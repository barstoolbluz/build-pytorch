# PyTorch optimized for NVIDIA DGX Spark (SM121) + AVX-512 BF16
# Package name: pytorch-python313-cuda12_8-sm121-avx512bf16
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_8-sm121-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch for NVIDIA DGX Spark (SM121) + AVX-512 BF16";
      longDescription = ''
        ...
        Choose this if: You have DGX Spark specialized datacenter GPU and CPU with
        AVX-512 BF16 support for BF16 (Brain Float 16) mixed-precision training on CPU.
        For general workloads use avx512, for INT8 inference use avx512vnni.
      '';
