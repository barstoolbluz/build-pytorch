...
# Package name: torchaudio-python311-cuda12_8-sm75-avx
...
in
  (nixpkgs_pinned.python311Packages.torchaudio.override {
    ...
    pname = "torchaudio-python311-cuda12_8-sm75-avx";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        Custom torchaudio build matching the pytorch-python311-cuda12_8-sm75-avx variant:
