...
# Package name: pytorch-python312-cpu-avx512vnni
#
...
in nixpkgs_pinned.python312Packages.torch.overrideAttrs (oldAttrs: {
  pname = "pytorch-python312-cpu-avx512vnni";
  ...
  '';
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        ...
        vLLM compatibility: Uses same nixpkgs pin (46336d4) as build-vllm/vllm-0.14.0.
