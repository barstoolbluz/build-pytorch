# PyTorch 2.10.0 optimized for NVIDIA B100/B200 (SM100) + AVX2
# Package name: pytorch210-python313-cuda13_0-sm100-avx2
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm100-avx2";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM100 (B100/B200) | CPU: AVX2 | PyTorch 2.10.0 | CUDA 13.0"
    '';
