# PyTorch optimized for NVIDIA Volta (SM70: V100, Titan V) + AVX
# Package name: pytorch-python311-cuda12_8-sm70-avx
...
let
  ...
  gpuArchSM = "7.0";  # For TORCH_CUDA_ARCH_LIST (dot notation required for older archs)
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python311-cuda12_8-sm70-avx";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        ...
        Choose this if: You have a Volta GPU and want CUDA acceleration
