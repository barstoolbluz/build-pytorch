# PyTorch 2.10.0 optimized for NVIDIA Rubin (Future) (SM120) + ARMv9
# Package name: pytorch210-python313-cuda13_0-sm120-armv9
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm120-armv9";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM120 (Rubin (Future)) | CPU: ARMv9 | PyTorch 2.10.0 | CUDA 13.0"
    '';
...
EOF
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA Rubin (Future) (SM120) + ARMv9";
