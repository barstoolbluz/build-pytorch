...
# Package name: pytorch-python313-cuda12_8-sm75-armv8_2
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_8-sm75-armv8_2";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch for NVIDIA T4/RTX 2080 Ti (SM75, Turing) + ARMv8.2 (Graviton2)";
      longDescription = ''
