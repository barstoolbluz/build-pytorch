# PyTorch 2.10.0 optimized for NVIDIA Ampere Datacenter (SM80: A100, A30) + AVX
# Package name: pytorch-python313-cuda12_9-sm80-avx
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_9-sm80-avx";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (Ampere DC: A100, A30)"
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA A100/A30 (SM80, Ampere DC) with AVX";
      longDescription = ''
        ...
        Choose this if: You have an Ampere datacenter GPU and want CUDA
