...
# Package name: torchaudio-python312-cuda12_8-sm61-avx
...
in
  (nixpkgs_pinned.python312Packages.torchaudio.override {
    torch = customPytorch;
  }).overrideAttrs (oldAttrs: {
    pname = "torchaudio-python312-cuda12_8-sm61-avx";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        Custom torchaudio build matching the pytorch-python312-cuda12_8-sm61-avx variant:
