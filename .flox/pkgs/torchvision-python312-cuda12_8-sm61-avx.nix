...
# Package name: torchvision-python312-cuda12_8-sm61-avx
...
let
  ...
  customPytorch = import ./pytorch-python312-cuda12_8-sm61-avx.nix {};
...
in
  (nixpkgs_pinned.python312Packages.torchvision.override {
    torch = customPytorch;
  }).overrideAttrs (oldAttrs: {
    pname = "torchvision-python312-cuda12_8-sm61-avx";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        Custom torchvision build matching the pytorch-python312-cuda12_8-sm61-avx variant:
