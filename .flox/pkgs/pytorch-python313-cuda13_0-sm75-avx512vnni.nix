# PyTorch 2.10.0 optimized for NVIDIA Turing (SM75) + AVX512-VNNI
# Package name: pytorch210-python313-cuda13_0-sm75-avx512vnni
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm75-avx512vnni";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM75 (Turing) | CPU: AVX512-VNNI | PyTorch 2.10.0 | CUDA 13.0"
    '';
...
EOF
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA Turing (SM75) + AVX512-VNNI";
