...
# Package name: pytorch210-python313-cuda13_1-sm86-armv8_2
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_1-sm86-armv8_2";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM86 (DRIVE Thor) | CPU: ARMv8.2 | PyTorch 2.10.0 | CUDA 13.1"
    '';
