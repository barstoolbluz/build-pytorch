# PyTorch 2.10.0 optimized for NVIDIA B100 (Blackwell) (SM100) + ARMv8.2
# Package name: pytorch210-python313-cuda13_0-sm100-armv8_2
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm100-armv8_2";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM100 (B100 (Blackwell)) | CPU: ARMv8.2 | PyTorch 2.10.0 | CUDA 13.0"
    '';
...
EOF
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA B100 (Blackwell) (SM100) + ARMv8.2";
