# PyTorch 2.10.0 optimized for NVIDIA B300 (SM103) + AVX-512
# Package name: pytorch210-python313-cuda13_0-sm103-avx512
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm103-avx512";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM103 (B300) | CPU: AVX-512 | PyTorch 2.10.0 | CUDA 13.0"
    '';
...
EOF
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA B300 (SM103) + AVX-512";
