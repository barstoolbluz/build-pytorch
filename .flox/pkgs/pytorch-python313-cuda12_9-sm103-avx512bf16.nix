# PyTorch 2.10.0 optimized for NVIDIA Blackwell B300 Datacenter (SM103: B300) + AVX-512 with BF16
# Package name: pytorch-python313-cuda12_9-sm103-avx512bf16
...
let
  ...
  cpuFlags = [
    "-mavx512f" "-mavx512dq" "-mavx512vl" "-mavx512bw" "-mavx512bf16" "-mfma"
  ];
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch-python313-cuda12_9-sm103-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA B300 (SM103, Blackwell DC) + AVX-512 BF16";
      longDescription = ''
