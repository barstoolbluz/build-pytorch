# PyTorch 2.10.0 optimized for NVIDIA Ada Lovelace (SM89: RTX 4090, L40) + ARMv9
# Package name: pytorch-python313-cuda12_8-sm89-armv9
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA RTX 4090/L40 (SM89) + ARMv9 (SVE2)";
      longDescription = ''
