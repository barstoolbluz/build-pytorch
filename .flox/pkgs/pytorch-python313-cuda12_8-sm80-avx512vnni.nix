# PyTorch 2.10.0 optimized for NVIDIA Ampere Datacenter (SM80: A100, A30) + AVX-512 + VNNI
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA A100/A30 (SM80, Ampere) + AVX-512 VNNI";
      longDescription = ''
