# PyTorch 2.10.0 optimized for NVIDIA RTX 40 Ada (SM89) + AVX512-VNNI
# Package name: pytorch210-python313-cuda13_0-sm89-avx512vnni
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm89-avx512vnni";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM89 (RTX 40 Ada) | CPU: AVX512-VNNI | PyTorch 2.10.0 | CUDA 13.0"
    '';
...
EOF
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA RTX 40 Ada (SM89) + AVX512-VNNI";
