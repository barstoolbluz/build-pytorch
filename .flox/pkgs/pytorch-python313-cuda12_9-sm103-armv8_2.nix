# PyTorch 2.10.0 optimized for NVIDIA Blackwell B300 Datacenter (SM103: B300) + ARMv8.2-A
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA B300 (SM103, Blackwell DC) + ARMv8.2";
      longDescription = ''
