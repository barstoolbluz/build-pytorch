...
# Package name: pytorch210-python313-cuda13_1-sm89-avx
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_1-sm89-avx";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM89 (Ada Lovelace) | CPU: AVX (max compat) | PyTorch 2.10.0 | CUDA 13.1"
    '';
