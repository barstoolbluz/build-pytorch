# PyTorch 2.10.0 for CPU-only + ARMv8.2
# Package name: pytorch210-python313-cpu-armv8_2
#
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cpu-armv8_2";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 CPU-only + ARMv8.2";
      longDescription = ''
