# PyTorch 2.10.0 optimized for NVIDIA DGX Spark (SM121) + AVX-512 BF16
# Package name: pytorch210-python313-cuda13_0-sm121-avx512bf16
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm121-avx512bf16";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM121 (DGX Spark) | CPU: AVX-512 BF16 | PyTorch 2.10.0 | CUDA 13.0"
    '';
...
EOF
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA DGX Spark (SM121) + AVX-512 BF16";
