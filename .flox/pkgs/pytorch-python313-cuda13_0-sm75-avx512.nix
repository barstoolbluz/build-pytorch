# PyTorch 2.10.0 optimized for NVIDIA Turing (SM75) + AVX512
# Package name: pytorch210-python313-cuda13_0-sm75-avx512
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm75-avx512";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM75 (Turing) | CPU: AVX512 | PyTorch 2.10.0 | CUDA 13.0"
    '';
...
EOF
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA Turing (SM75) + AVX512";
