# PyTorch optimized for NVIDIA Blackwell B300 Datacenter (SM103: B300) + AVX-512 BF16
# Package name: pytorch-python313-cuda12_8-sm103-avx512bf16
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_8-sm103-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch for NVIDIA B300 (SM103, Blackwell DC) + AVX-512 BF16";
      longDescription = ''
        ...
        Choose this if: You have B300 datacenter GPU and CPU with AVX-512 BF16 support,
        and need BF16 (Brain Float 16) mixed-precision training on CPU. For general
