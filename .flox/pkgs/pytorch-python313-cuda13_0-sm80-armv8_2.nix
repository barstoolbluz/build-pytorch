# PyTorch 2.10.0 optimized for NVIDIA A100 (Ampere) (SM80) + ARMv8.2
# Package name: pytorch210-python313-cuda13_0-sm80-armv8_2
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm80-armv8_2";
    patches = [];
    ninjaFlags = [ "-j32" ];
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM80 (A100 (Ampere)) | CPU: ARMv8.2 | PyTorch 2.10.0 | CUDA 13.0"
    '';
...
EOF
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA A100 (Ampere) (SM80) + ARMv8.2";
