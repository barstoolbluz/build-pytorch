# PyTorch 2.10.0 optimized for NVIDIA Pascal (SM61: GTX 1070, 1080, 1080 Ti) + AVX2
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA GTX 1070/1080 Ti (SM61, Pascal) with AVX2";
      longDescription = ''
