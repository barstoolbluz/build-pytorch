...
# Package name: pytorch210-python313-cuda13_1-sm103-avx512vnni
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_1-sm103-avx512vnni";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM103 (B300) | CPU: AVX-512 VNNI | PyTorch 2.10.0 | CUDA 13.1"
    '';
