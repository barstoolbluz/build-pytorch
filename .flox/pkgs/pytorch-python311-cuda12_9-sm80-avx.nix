...
# Package name: pytorch-python311-cuda12_9-sm80-avx
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python311-cuda12_9-sm80-avx";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch for NVIDIA A100/A30 (SM80, Ampere DC) with AVX";
      longDescription = ''
