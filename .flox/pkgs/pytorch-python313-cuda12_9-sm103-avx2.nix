# PyTorch 2.10.0 optimized for NVIDIA Blackwell B300 Datacenter (SM103: B300) + AVX2 (broader compatibility)
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA B300 (SM103, Blackwell DC) + AVX2";
      longDescription = ''
