# PyTorch 2.10.0 optimized for NVIDIA Blackwell DC (SM100: B100, B200) + AVX
# Package name: pytorch-python313-cuda12_9-sm100-avx
...
in
  ...
  # 2. Customize build (CPU flags, metadata, etc.)
    ...
    pname = "pytorch-python313-cuda12_9-sm100-avx";
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA B100/B200 (SM100, Blackwell DC) with AVX";
      longDescription = ''
