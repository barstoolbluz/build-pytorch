...
# Package name: torchaudio-python312-cuda12_8-sm75-avx
...
in
  (nixpkgs_pinned.python312Packages.torchaudio.override {
    ...
    pname = "torchaudio-python312-cuda12_8-sm75-avx";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        Custom torchaudio build matching the pytorch-python312-cuda12_8-sm75-avx variant:
