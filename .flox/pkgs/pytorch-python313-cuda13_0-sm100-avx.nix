...
# Package name: pytorch210-python313-cuda13_0-sm100-avx
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm100-avx";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM100 (Blackwell DC) | CPU: AVX (max compat) | PyTorch 2.10.0 | CUDA 13.0"
    '';
