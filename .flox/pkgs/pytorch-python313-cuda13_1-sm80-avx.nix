# PyTorch 2.10.0 optimized for NVIDIA Ampere DC (SM80) + AVX
# Package name: pytorch210-python313-cuda13_1-sm80-avx
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_1-sm80-avx";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "GPU: SM80 (Ampere DC) | CPU: AVX (max compat) | PyTorch 2.10.0 | CUDA 13.1"
    '';
...
EOF
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA Ampere DC (SM80) + AVX";
