...
# Package name: pytorch210-python313-cuda13_0-sm120-avx512-magma
#
# TEST RECIPE: This variant enables MAGMA with the CUDA 13.0 compatibility patch.
# If this builds successfully, we can migrate all recipes to use this pattern.
#
# MAGMA patch: https://github.com/icl-utk-edu/magma/commit/235aefb7b064954fce09d035c69907ba8a87cbcd
# Issue: https://github.com/icl-utk-edu/magma/issues/61
...
let
  ...
  # NOTE: No filterMagma helper - MAGMA is now enabled via patched overlay
...
in
  (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-python313-cuda13_0-sm120-avx512-magma";

    # Clear patches - they reference submodule paths that don't exist in tarball
    patches = [];

    # NOTE: No MAGMA filtering - dependencies include MAGMA via patched overlay
    # buildInputs, nativeBuildInputs, propagatedBuildInputs use defaults
    ...
    # NOTE: No -DUSE_MAGMA=OFF - MAGMA is enabled
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      # NOTE: No USE_MAGMA=0 - MAGMA is enabled via patched overlay
...
EOF
    ...
    meta = oldAttrs.meta // {
      description = "PyTorch 2.10.0 for NVIDIA RTX 5090 (SM120, Blackwell) + AVX-512 + MAGMA";
      longDescription = ''
        ...
        - MAGMA: ENABLED (patched for CUDA 13.0 compatibility)
        - Python: 3.13
        ...
        This build includes MAGMA for GPU-accelerated sparse matrix operations.
      '';
