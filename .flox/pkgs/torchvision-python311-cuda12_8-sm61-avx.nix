...
# Package name: torchvision-python311-cuda12_8-sm61-avx
...
in
  (nixpkgs_pinned.python311Packages.torchvision.override {
    ...
    pname = "torchvision-python311-cuda12_8-sm61-avx";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        Custom torchvision build matching the pytorch-python311-cuda12_8-sm61-avx variant:
